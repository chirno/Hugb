...
public interface ProfileRepository extends JpaRepository<Profile, Long>{
	...
	<Test extends Profile>Test save(Test entity);
	...
	void delete(Iterable<? extends Profile> entities);
	...
	List<Profile> findAll(Iterable<Long> ids);
	
	/*Saves all given entities.*/
	<Test extends Profile>List<Test> save(Iterable<Test> entities);
	
	/*Flushes all pending changes to the database.*/
	void flush();
	
	/*Saves an entity and flushes changes instantly.*/
	<Test extends Profile> Test saveAndFlush(Test entity);

...
import project.persistence.entities.Settings;
...
public interface SettingsRepository extends JpaRepository<Settings, Long>{
	...
	<Test extends Settings>Test save(Test entity);
	...
	List<Settings> findAll(Sort sort);
	
	/*Returns all instances of the type with the given IDs.*/
	List<Settings> findAll(Iterable<Long> ids);
	
	/*Saves all given entities.*/
	<Test extends Settings>List<Test> save(Iterable<Test> entities);
	
	/*Flushes all pending changes to the database.*/
	void flush();
	
	/*Saves an entity and flushes changes instantly.*/
	<Test extends Settings> Test saveAndFlush(Test entity);
	...
	void deleteInBatch(Iterable<Settings> entities);
	
	/*Deletes all entities in a batch call.*/
	void deleteAllInBatch();
	
	/*Returns a reference to the entity with the given identifier.*/
	Settings getOne(Long id);
}